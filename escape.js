alert("Turn on sounds for a better experience. If there's any errors, please let me know!");
...
function Direction5(Choice){
    ...
    if(Choice == "red2"){
        document.getElementById("result5").innerHTML = "<br><br>Looks like you're almost out! Just to make sure, Did you Subscribe to Kalmai221 Plays?";
...
function Direction6(Choice){
    if(Choice == "yes"){
        document.getElementById("result6").innerHTML = "<br><br>WOOOOO YOU MADE IT! CONGRATS! *gives high five* ;)<br>";
